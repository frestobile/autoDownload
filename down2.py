...
# Example usage
base_url_pattern = "http://localhost:8080/styles/basic-preview/256/14/{}/{}"  # URL pattern with placeholders for folder and file
folder_start = 8014  # Start of the folder range
folder_end = 8093    # End of the folder range
file_start = 5166    # Start of the file range
file_end = 5269      # End of the file range
base_directory = "./Downloads/14/"  # Local base directory for saving images
